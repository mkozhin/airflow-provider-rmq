...
Переключатель управляет доступом, а не только выдачей: ложное значение **снимает** те же шесть прав с роли Op на следующем старте веб-сервера. Выдавать или отбирать их руками при истинном или незаданном значении бессмысленно — старт вернёт ответ провайдера на место.
