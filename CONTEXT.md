...
`[rmq_watcher] grant_op_access` управляет доступом, а не выдачей: ложное значение права снимает,
а нечитаемое не делает ни того, ни другого. Переключатель живёт в конфигурации, а не в Variable,
