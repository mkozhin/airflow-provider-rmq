...
- **Added:** Statsd metrics `rmq_watcher.consumer_attached`, `rmq_watcher.consumer_restarted`, `rmq_watcher.dag_triggered`, `rmq_watcher.cycle_timed_out`, `rmq_watcher.cycle_step_timed_out` and `rmq_watcher.cycle_step_skipped` (no-ops when statsd is not configured)
